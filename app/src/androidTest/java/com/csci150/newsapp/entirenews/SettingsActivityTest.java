...
public class SettingsActivityTest {
    ...
    public void settingsActivityTest() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(android.R.id.title), withText("Select news sources"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView2.check(matches(withText("Select news sources")));

        ViewInteraction textView3 = onView(
                allOf(withId(android.R.id.title), withText("Notifications"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
                                        1),
